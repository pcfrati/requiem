...
imagem.src = "https://i.ibb.co/Ld2xMcz9/zoios.png";
...
function desenhar() {
  ...
  if (Math.abs(pos1 - centro1) < 5 && Math.abs(pos2 - centro2) < 5) {
    ...
    if (!imagemRevelada) {
      ...
      gifElement.src = "https://raw.githubusercontent.com/pcfrati/requiem/refs/heads/main/requiemminijogos/borrao/img/zoios.gif";
